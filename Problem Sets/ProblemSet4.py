...
"""
For mode, this program would crash. Instead, use try/except:
    try:
      print(statistics.mode(ran_list))
    except Exception as e: # could also use "statistics.StatisticsError" instead of                                                                         'Exception'
      print ("Mode Error: ", e)
"""
#%%
"""
